...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='TriDM')
    ...
    parser.add_argument('--model_id', type=str, default='TriDM_ETT_720_720', help='model id')
    parser.add_argument('--model', type=str,  default='TriDM',
    ...
    parser.add_argument('--label_len', type=int, default=360, help='start token length')
    ...
    parser.add_argument('--grid_size', type=int, default=5, help='grid size for KAN networks (default: 3 for small datasets like ETTh, use 5-10 for large datasets)')
